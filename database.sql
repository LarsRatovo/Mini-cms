...
INSERT INTO paragraphs(article, image, title, text) VALUES (4, 'ia.jpg', 'Définition', 'L''IA désigne l''ensemble des techniques et des méthodes permettant de concevoir des programmes informatiques capables de reproduire des comportements ou des fonctions qui, pour un être humain, demandent de l''intelligence.');
INSERT INTO paragraphs(article, image, title, text) VALUES (4, 'ia2.jpg', 'Histoire', 'Les premières recherches en IA remontent aux années 1950. À cette époque, les chercheurs cherchaient à comprendre comment les machines pourraient imiter la pensée humaine et résoudre des problèmes complexes.');
...
INSERT INTO paragraphs(article, image, title, text) VALUES (5, 'ai1.jpg', 'Santé', 'L''IA est utilisée pour la détection précoce de maladies et la recherche de traitements personnalisés pour chaque patient. Elle peut également être utilisée pour améliorer les résultats de la chirurgie et de la réadaptation.');
INSERT INTO paragraphs(article, image, title, text) VALUES (5, 'ai2.jpg', 'Finance', 'L''IA est utilisée pour l''analyse des données financières et l''identification des tendances du marché. Elle permet également d''automatiser des tâches telles que la détection de fraudes, la gestion des risques ou la surveillance des investissements.');
...
INSERT INTO paragraphs(article, image, title, text) VALUES (6, 'ai3.jpg', 'Biais', 'Les systèmes d''IA peuvent être biaisés en fonction des données sur lesquelles ils ont été entraînés. Par exemple, si les données utilisées pour former un système de reconnaissance faciale ne représentent pas de manière équitable toutes les populations, le système peut produire des résultats erronés pour certaines personnes.');

INSERT INTO articles(category, title, date, image, snippet) VALUES (1, 'Qu''est-ce que l''IA ?', '2023-05-07', 'ia.jpg', 'L''intelligence artificielle (IA) est un domaine de l''informatique qui vise à créer des machines capables de réaliser des tâches qui nécessitent normalement l''intelligence humaine, comme la reconnaissance vocale ou visuelle, la prise de décision ou le raisonnement. Cette technologie est de plus en plus présente dans notre quotidien.');
INSERT INTO paragraphs(article, image, title, text) VALUES (7, 'ia1.jpg', 'Définition', 'L''IA désigne l''ensemble des techniques et des méthodes permettant de concevoir des programmes informatiques capables de reproduire des comportements ou des fonctions qui, pour un être humain, demandent de l''intelligence.');
INSERT INTO paragraphs(article, image, title, text) VALUES (7, 'ia2.jpg', 'Histoire', 'Les premières recherches en IA remontent aux années 1950. À cette époque, les chercheurs cherchaient à comprendre comment les machines pourraient imiter la pensée humaine et résoudre des problèmes complexes.');

INSERT INTO articles(category, title, date, image, snippet) VALUES (2, 'Applications de l''IA', '2023-05-08', 'ai-applications.jpg', 'L''intelligence artificielle est utilisée dans de nombreux domaines, tels que la médecine, la finance, les transports, la sécurité ou encore l''énergie. Elle permet notamment d''automatiser des tâches, de prendre des décisions en temps réel ou de prédire des comportements.');
INSERT INTO paragraphs(article, image, title, text) VALUES (8, 'ai1.jpg', 'Santé', 'L''IA est utilisée pour la détection précoce de maladies et la recherche de traitements personnalisés pour chaque patient. Elle peut également être utilisée pour améliorer les résultats de la chirurgie et de la réadaptation.');
INSERT INTO paragraphs(article, image, title, text) VALUES (8, 'ai2.jpg', 'Finance', 'L''IA est utilisée pour l''analyse des données financières et l''identification des tendances du marché. Elle permet également d''automatiser des tâches telles que la détection de fraudes, la gestion des risques ou la surveillance des investissements.');

INSERT INTO articles(category, title, date, image, snippet) VALUES (3, 'Limites de l''IA', '2023-05-09', 'ai-limites.jpg', 'Malgré ses nombreuses applications, l''IA présente également des limites et des risques, tels que la dépendance aux données, la perte d''emplois, l''introduction de biais ou la prise de décisions incohérentes.');
INSERT INTO paragraphs(article, image, title, text) VALUES (9, 'ai3.jpg', 'Biais', 'Les systèmes d''IA peuvent être biaisés en fonction des données sur lesquelles ils ont été entraînés. Par exemple, si les données utilisées pour former un système de reconnaissance faciale ne représentent pas de manière équitable toutes les populations, le système peut produire des résultats erronés pour certaines personnes.');
...
VALUES (10, 'ia-representation.jpg', 'Représentation de l''IA', 'L''intelligence artificielle est une technologie qui permet à une machine de simuler l''intelligence humaine. Elle peut prendre plusieurs formes, comme les chatbots, les systèmes de reconnaissance vocale ou encore les voitures autonomes.');
INSERT INTO paragraphs (article, image, title, text)
VALUES (10, 'ia-apprentissage.jpg', 'Apprentissage automatique', 'L''apprentissage automatique est l''un des principaux domaines de l''intelligence artificielle. Il permet à une machine d''apprendre de manière autonome à partir de données et de prendre des décisions en conséquence.');
INSERT INTO paragraphs (article, image, title, text)
VALUES (10, NULL, 'Les différentes approches de l''IA', 'Il existe plusieurs approches de l''intelligence artificielle, comme l''apprentissage profond, l''apprentissage supervisé ou encore l''apprentissage non supervisé.');
INSERT INTO paragraphs (article, image, title, text)
VALUES (10, 'ia-automate.jpg', 'Automate programmable', 'L''automate programmable est le premier type d''intelligence artificielle. Il permet de programmer une machine pour qu''elle effectue des tâches spécifiques.');
INSERT INTO paragraphs (article, image, title, text)
VALUES (10, 'ia-symbolique.jpg', 'IA symbolique', 'L''intelligence artificielle symbolique utilise des règles et des symboles pour simuler le raisonnement humain.');
INSERT INTO paragraphs (article, image, title, text)
VALUES (10, 'ia-connexionniste.jpg', 'IA connexionniste', 'L''intelligence artificielle connexionniste est basée sur les réseaux de neurones artificiels, qui simulent le fonctionnement du cerveau humain.');

INSERT INTO articles (category, title) VALUES (1, 'Qu''est-ce que l''IA ?');
INSERT INTO paragraphs (article, title, "text") VALUES (11, 'Définition de l''IA', 'L''intelligence artificielle (IA) est un domaine de l''informatique qui se consacre à la conception de machines capables de reproduire des comportements intellectuels humains, comme la perception, l''apprentissage, le raisonnement et la prise de décision.');

INSERT INTO articles (category, title) VALUES (2, 'Utilisations de l''IA');
INSERT INTO paragraphs (article, title, "text") VALUES (12, 'L''IA dans les systèmes de recommandation', 'L''IA est largement utilisée dans les systèmes de recommandation, comme ceux utilisés par Netflix ou Amazon, pour proposer des produits ou des contenus adaptés aux goûts de l''utilisateur.');
INSERT INTO paragraphs (article, title, "text") VALUES (12, 'L''IA dans la santé', 'L''IA est utilisée dans de nombreux domaines de la santé, tels que la détection précoce de maladies, l''analyse d''images médicales et la découverte de nouveaux médicaments.');

INSERT INTO articles (category, title) VALUES (3, 'Limites de l''IA');
INSERT INTO paragraphs (article, title, "text") VALUES (13, 'Limites éthiques', 'L''IA soulève de nombreuses questions éthiques, comme la responsabilité en cas d''erreur ou d''accident causé par une machine autonome, ou la question de savoir si une machine peut réellement avoir une conscience.');
INSERT INTO paragraphs (article, title, "text") VALUES (13, 'Limites techniques', 'Malgré des progrès significatifs, l''IA présente encore de nombreuses limites techniques, notamment en ce qui concerne la compréhension du langage naturel ou la capacité à apprendre de manière autonome.');

INSERT INTO articles (category, title) VALUES (4, 'Nouveautés en IA');
INSERT INTO paragraphs (article, title, "text") VALUES (14, 'GPT-3', 'GPT-3 est une IA développée par OpenAI qui est capable de produire du texte de qualité équivalente à celui écrit par un humain. Elle a suscité beaucoup d''enthousiasme et de craintes quant à son potentiel pour révolutionner les industries créatives et la manière dont nous communiquons en ligne.');
INSERT INTO paragraphs (article, title, "text") VALUES (14, 'DeepMind et AlphaFold', 'DeepMind, une filiale de Google, a récemment développé une IA appelée AlphaFold qui est capable de prédire la structure tridimensionnelle des protéines avec une précision comparable à celle obtenue par des méthodes expérimentales coûteuses. Cette avancée pourrait avoir un impact significatif sur la recherche médicale et pharmaceutique.');
