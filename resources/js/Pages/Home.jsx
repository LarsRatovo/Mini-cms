            ...
            <Navbar global={global} categories={categories}>
                <section id="hero" className="hero">
                    ...
                    <div className="row gy-5" data-aos="fade-in">
                        ...
                        <img src="assets/img/ai.png" className="img-fluid" alt="" width={546} height={364}/>
                        </div>
                    </div>
                    </div>
                </section>
                                ...
                                <div class="row">
                                    {cat.articles.map(article=>
                                        <div class="col-lg-4">
                                            ...
                                            <h3>{article.title}</h3>
                                            <img src={"assets/img/"+article.image} className="img-fluid rounded-4 mb-4" width={356} height={237.33} alt={article.title} />
